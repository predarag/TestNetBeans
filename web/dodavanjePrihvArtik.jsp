    ...
    <div class="large-9 columns" role="content">
      ...
      <article>
          ...
          <div id="form">
            ...
            <form name="forma" action="DodavanjePrihvArtik" method="post" >
               
                
                <div class="red">
                <div class="label"> ID zahteva </div> <!-- kraj labele-->
                <div class="input">
                    <input name="id" type="text"  class="detail" id="fullname" value="<%out.println(request.getParameter("id"));%>" readonly/>
                </div> <!-- kraj inputa -->
                </div> <!-- kraj rowa -->
                ...
                <div class="input">
                    <input name="vrsta" type="text"  class="detail" id="fullname" value="<%out.println(request.getParameter("tip"));%>" readonly/>
                </div> <!-- kraj inputa -->
                </div> <!-- kraj rowa -->
                ...
                <div class="input">
                    <input name="naziv" type="text"  class="detail" id="fullname" value="<%out.println(request.getParameter("naziv"));%>" readonly/>
                </div> <!-- kraj inputa -->
                </div> <!-- kraj rowa -->
                ...
                <div class="input">
                     <input name="idLab" type="text"  class="detail" id="fullname" value="<%out.println(request.getParameter("idLab"));%>" readonly/>
                </div> <!-- kraj inputa -->
                </div> <!-- kraj rowa -->
                ...
                <div class="input">
                    <input name="kolicina" type="text"  class="detail" id="fullname" value="<%out.println(request.getParameter("kolicina"));%>" readonly>
                </div> <!-- kraj inputa -->
                </div> <!-- kraj rowa -->
